...
if ( ! function_exists( 'blackboard_by_zdc_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'blackboard_by_zdc-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.125', 'all');

    wp_deregister_style( 'blackboard_by_zdc-style' );
    wp_enqueue_style( 'blackboard_by_zdc-style', get_bloginfo('stylesheet_url'), [], '1.0.125', 'all');
