...
if ( ! function_exists( 'blackboard_by_zdc_enqueue_scripts' ) ) :
    ...
    wp_enqueue_style( 'blackboard_by_zdc-tailwind', get_template_directory_uri() . '/tailwind_theme/tailwind.css', [], '1.0.137', 'all');

    wp_deregister_style( 'blackboard_by_zdc-style' );
    wp_enqueue_style( 'blackboard_by_zdc-style', get_bloginfo('stylesheet_url'), [], '1.0.137', 'all');
...
function blackboard_by_zdc_blocks_init() {
    ...
    require_once 'blocks/page-label/page-label_register.php';
    require_once 'blocks/hero/hero_register.php';
    require_once 'blocks/pricing-tier/pricing-tier_register.php';
    require_once 'blocks/pricing-overview/pricing-overview_register.php';
    require_once 'blocks/price-factor/price-factor_register.php';
    require_once 'blocks/price-factors/price-factors_register.php';
    require_once 'blocks/comparison/comparison_register.php';
    require_once 'blocks/separate-cost-item/separate-cost-item_register.php';
    require_once 'blocks/separate-costs/separate-costs_register.php';
    require_once 'blocks/budget-and-quotes/budget-and-quotes_register.php';
    require_once 'blocks/call-to-action/call-to-action_register.php';
    ...
    require_once 'blocks/header-alternative/header-alternative_register.php';
